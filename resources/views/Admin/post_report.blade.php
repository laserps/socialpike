        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detail" id="add_detail"  placeholder="detail">
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detail" id="edit_detail"  placeholder="detail">
                </div>
...
<script>
     ...
     var TableList = $('#TableList').dataTable({
        "ajax": {
            "url": url_gb+"/admin/PostReport/Lists",
            "data": function ( d ) {
                //d.myKey = "myValue";
    ...
    $('body').on('click','.btn-edit',function(data){
        ...
        $.ajax({
            method : "GET",
            url : url_gb+"/admin/PostReport/"+id,
            dataType : 'json'
        }).done(function(rec){
	...
	$('body').on('click','.btn-delete',function(e){
        ...
        swal({
            ...
            if(data){
                $.ajax({
                    method : "POST",
                    url : url_gb+"/admin/PostReport/Delete/"+id,
                    data : {ID : id}
                }).done(function(rec){
                    if(rec.status==1){
                        swal(rec.title,rec.content,"success");
