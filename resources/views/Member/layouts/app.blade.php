...
<html lang="{{ app()->getLocale() }}">
    ...
    <!-- Plugin -->
    <!-- OFFICEDD CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/member/assets/css/main.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/member/assets/css/live-chat.css')}}">
