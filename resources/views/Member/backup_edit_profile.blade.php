...
<script>
    ...
    $('body').on('keyup','.school',function(){
    	...
    	$.ajax({
            type : "get",
            url : "https://maps.googleapis.com/maps/api/place/queryautocomplete/json?&key=AIzaSyDykbjLvRQk0S54PcHHBFpANU5385S-hYA&language=th&input="+keyword+"&libraries=places",
            dataType: 'json',
            cache: false,
