  		...
  		<section class="" id="section-top">
	  		<div class="jumbotron master">
	  				...
	  				<div class="container">
	  					<div class="row">
	  						<div class="col-md-8 ml-auto displayTitle">
	  							<div class="displayName ml-auto ml-md-0">
	  			...
	  			<div class="container" style="position: relative;">
	  				<div class="image">
						<img src="assets/images/girl.jpg" alt="Circle Image" class="rounded-circle img-fluid">
					</div>
	  			</div>
  				...
  				<div class="row">
  					...
  					<div class="col-12 col-md-8 ml-auto">
  						<div class="menu-bar">
							  ...
							  <li class="nav-item">
							    <a class="nav-link active" href="profile.php">Post</a>
							  </li>
							  <li class="nav-item">
							    <a class="nav-link" href ="info.php">Info</a>
							  </li>
							  <li class="nav-item">
							    <a class="nav-link" href="friends.php">Friend</a>
							  </li>
							  <li class="nav-item">
							    <a class="nav-link" href="album.php">Photo</a>
							  </li>
							  ...
							  <li class="nav-item btn-nav ml-auto">
							  		<a class="btn btn-ghost" href="#"><span class="btn-edit"></span></a>
							  </li>
							</ul>
			  			</div>
  					</div>
								...
								<div class="card">
								  <div class="card-body-xs">
								    <h5>People you should meet</h5>
									    <div class="nf-item">
									    	<a href="#">
										    	<img src="assets/images/girl4.jpg" class="img-fluid rounded-circle image-rec-friend" alt="Profile image">
										    </a>
										    <a href="#">
									    ...
									    <div class="nf-item">
									    	<a href="#">
										    	<img src="assets/images/girl2.jpg" class="img-fluid rounded-circle image-rec-friend" alt="Profile image">
										    </a>
										    <a href="#">
										    	<label class="font-header-rec-friend">Allison Clayborne</label>
										    </a>
									    ...
									    <div class="nf-item">
									    	<a href="#">
										    	<img src="assets/images/girl3.jpg" class="img-fluid rounded-circle image-rec-friend" alt="Profile image">
										    </a>
										    <a href="#">
										    	<label class="font-header-rec-friend">Allison Clayborne</label>
										    </a>
...
<!-- Modal Direct MSG -->
	<div class="modal fade" id="directMessageModal" tabindex="-1" role="dialog" aria-labelledby="directMessageModalTitle" aria-hidden="true">
	  <div class="modal-dialog modal-message modal-dialog-centered" role="document">
	    <div class="modal-content modal-content-msg">
	      	...
	      	<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane show active" id="nav-message" role="tabpanel" aria-labelledby="nav-message-tab">
				  	<div class="msg-sidebar widget" id="msg-sidebar-widget">
						<div class="modal-body">
					        ...
					        <div class="all-chat">
					        	<div class="nf-item d-flex flex-row">
									<div class="py-3 px-4">
									  	<a href="#">
									    	<img src="assets/images/girl2.jpg" class="img-fluid rounded-circle image-friend-comment" alt="Profile image">
									   	</a>
									</div>
								  	<div class="p-3 pl-5">
								  		<a href="#">
				  		...
				  		<div class="modal-body">
					        ...
					        <div class="all-chat">
					        	<div class="nf-item d-flex flex-row">
									<div class="py-3 pr-4">
									  	<a href="#">
									    	<img src="assets/images/girl4.jpg" class="img-fluid rounded-circle image-friend-comment" alt="Profile image">
									   	</a>
									</div>
								  	<div class="py-4 px-5">
								  		<a href="#">
					        ...
					        <div class="all-chat">
					        	<div class="nf-item d-flex flex-row">
									<div class="py-3 pr-4">
									  	<a href="#">
									    	<img src="assets/images/girl3.jpg" class="img-fluid rounded-circle image-friend-comment" alt="Profile image">
									   	</a>
									</div>
								  	<div class="py-4 px-5">
								  		<a href="#">
					        ...
					        <div class="all-chat">
					        	<div class="nf-item d-flex flex-row">
									<div class="py-3 pr-4">
									  	<a href="#">
									    	<img src="assets/images/men2.jpg" class="img-fluid rounded-circle image-friend-comment" alt="Profile image">
									   	</a>
									</div>
								  	<div class="py-4 px-5">
								  		<a href="#">
...
<!-- Modal Share -->
	<div class="modal" id="shareModal" tabindex="-1" role="dialog" aria-labelledby="shareModalTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
	    <div class="modal-content modal-content-share">
	      	...
	      	<div class="modal-footer">
				<div class="dropdown option-action-more">
					<span class="dropdown-toggle share-dropdown-action-more" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						Public
					</span>
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
						<a class="dropdown-item" href="#">Public</a>
...
<!-- Modal Chat -->
	<div class="modal" id="chatModal" tabindex="-1" role="dialog" aria-labelledby="chatModalTitle" aria-hidden="true">
	  <div class="modal-dialog modal-chat modal-dialog-centered" role="document">
	      ...
	      <div class="modal-body">
	      	...
	      	<div class="msg-sidebar widget" id="msg-sidebar-widget">
		        <div class="chatbox">
					<ol class="chat">
				      <li class="other">
				          <div class="avatar"><img src="assets/images/girl2.jpg" class="img-fluid rounded-circle" alt="Profile image"></div>
				        <div class="msg">
				          <p>Hola!</p>
				      ...
				      <li class="self">
				          <div class="avatar"><img src="assets/images/girl.jpg" class="img-fluid rounded-circle" alt="Profile image"></div>
				        <div class="msg">
			...
			<div class="card-footer-lg">
		    	...
		    	<div class="m-1 btn-coment" >
		    		<input type="submit" name="post" class="btn btn-post" value="SEND">
		    	</div>
			</div>
	    </div>
	  </div>
